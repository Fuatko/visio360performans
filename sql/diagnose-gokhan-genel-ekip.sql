-- Zümre Başkanı Gökhan BÜYÜKENGEZ — genel değerlendirme ekip kontrolü
...
with genel_liste as (
  ...
  where ea.period_id = 'a5bd7005-260f-4ac7-b864-ccc31ca0a5f6'
    and ev.name = 'Gökhan BÜYÜKENGEZ'
    and coalesce(ea.matrix_context, 'genel') = 'genel'
)
select 'SAYIM' as rapor, null::text as isim, format('gokhan_genel=%s', (select count(*) from genel_liste)) as detay
union all
