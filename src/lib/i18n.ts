...
export const dict: Dict = {
  ...
  menuSurvey: { tr: 'Anket', en: 'Survey', fr: 'Sondage' },
  menuSystem: { tr: 'Sistem', en: 'System', fr: 'Système' },
  surveyManagement: { tr: 'Anket Yönetimi', en: 'Survey Management', fr: 'Gestion des sondages' },
  surveyManagementSubtitle: {
    tr: 'Anket oluşturun, yanıtları toplayın ve AI destekli analiz edin',
    en: 'Create surveys, collect responses and analyze with AI',
    fr: 'Créez des sondages, collectez les réponses et analysez avec l’IA',
  },
  surveyCreateNew: { tr: 'Yeni Anket Oluştur', en: 'Create New Survey', fr: 'Créer un nouveau sondage' },
  surveyCreate: { tr: 'Oluştur', en: 'Create', fr: 'Créer' },
  surveyList: { tr: 'Anketler', en: 'Surveys', fr: 'Sondages' },
  surveyEmpty: { tr: 'Henüz anket yok.', en: 'No surveys yet.', fr: 'Aucun sondage pour le moment.' },
  surveyTitle: { tr: 'Anket Başlığı', en: 'Survey Title', fr: 'Titre du sondage' },
  surveyTitlePlaceholder: { tr: 'Örn. Çalışan Memnuniyeti Anketi', en: 'e.g. Employee Satisfaction Survey', fr: 'ex. Sondage de satisfaction' },
  surveyStatus: { tr: 'Durum', en: 'Status', fr: 'Statut' },
  surveyStatusDraft: { tr: 'Taslak', en: 'Draft', fr: 'Brouillon' },
  surveyStatusActive: { tr: 'Yayında', en: 'Active', fr: 'Actif' },
  surveyStatusClosed: { tr: 'Kapalı', en: 'Closed', fr: 'Fermé' },
  surveyAccess: { tr: 'Erişim', en: 'Access', fr: 'Accès' },
  surveyAccessBoth: { tr: 'İç + Public', en: 'Internal + Public', fr: 'Interne + Public' },
  surveyAccessInternal: { tr: 'Sadece iç kullanıcı', en: 'Internal only', fr: 'Interne uniquement' },
  surveyAccessPublic: { tr: 'Anonim public link', en: 'Public link', fr: 'Lien public' },
  surveyAnonymous: { tr: 'Anonim', en: 'Anonymous', fr: 'Anonyme' },
  surveyAnonymousBadge: { tr: 'Anonim', en: 'Anonymous', fr: 'Anonyme' },
  surveyResponsesCount: { tr: '{n} yanıt', en: '{n} responses', fr: '{n} réponses' },
  surveyOpenLink: { tr: 'Linki aç', en: 'Open link', fr: 'Ouvrir le lien' },
  surveyManage: { tr: 'Yönet', en: 'Manage', fr: 'Gérer' },
  surveyLoadFailed: { tr: 'Anketler yüklenemedi', en: 'Failed to load surveys', fr: 'Échec du chargement des sondages' },
  surveyDeleteConfirm: { tr: '“{title}” anketini silmek istediğinize emin misiniz? Tüm yanıtlar da silinir.', en: 'Delete survey “{title}”? All responses will be deleted.', fr: 'Supprimer le sondage « {title} » ? Toutes les réponses seront supprimées.' },
  selectOrganizationFirst: { tr: 'Önce bir kurum seçin', en: 'Please select an organization first', fr: 'Veuillez d’abord sélectionner une organisation' },
  missingFields: { tr: 'Zorunlu alanları doldurun', en: 'Please fill in the required fields', fr: 'Veuillez remplir les champs obligatoires' },
  saved: { tr: 'Kaydedildi', en: 'Saved', fr: 'Enregistré' },
  deleted: { tr: 'Silindi', en: 'Deleted', fr: 'Supprimé' },
  deleteFailed: { tr: 'Silme hatası', en: 'Delete failed', fr: 'Échec de la suppression' },
  yes: { tr: 'Evet', en: 'Yes', fr: 'Oui' },
  no: { tr: 'Hayır', en: 'No', fr: 'Non' },
  // Builder / detay
  surveyTabBuilder: { tr: 'Tasarım', en: 'Builder', fr: 'Conception' },
  surveyTabAssign: { tr: 'Atamalar', en: 'Assignments', fr: 'Attributions' },
  surveyTabResults: { tr: 'Sonuçlar', en: 'Results', fr: 'Résultats' },
  surveyTabAi: { tr: 'AI Analiz', en: 'AI Analysis', fr: 'Analyse IA' },
  surveyAssignIntro: {
    tr: 'Kişi seçip, konu başlığı ve/veya tekil soru bazında atama yapın. Kişi giriş yaptığında yalnızca kendine atanmış soruları görür.',
    en: 'Pick a person and assign by topic and/or individual questions. When they sign in, they only see their assigned questions.',
    fr: 'Choisissez une personne et attribuez par thème et/ou questions individuelles. À la connexion, elle ne voit que ses questions.',
  },
  surveyAssignUsers: { tr: 'Kişiler', en: 'People', fr: 'Personnes' },
  surveyAssignNoUsers: { tr: 'Bu kuruma ait kullanıcı bulunamadı.', en: 'No users found for this organization.', fr: 'Aucun utilisateur trouvé pour cette organisation.' },
  surveyAssignSelectUser: { tr: 'Atama yapmak için soldan bir kişi seçin.', en: 'Select a person on the left to assign.', fr: 'Sélectionnez une personne à gauche.' },
  surveyAssignQuestionCount: { tr: 'soru atanmış', en: 'questions assigned', fr: 'questions attribuées' },
  surveyAssignCategories: { tr: 'Konu başlıkları (bu başlığın tüm soruları)', en: 'Topics (all questions in the topic)', fr: 'Thèmes (toutes les questions du thème)' },
  surveyAssignNoCategories: { tr: 'Sorulara henüz konu başlığı girilmemiş.', en: 'No topics set on questions yet.', fr: 'Aucun thème défini sur les questions.' },
  surveyAssignQuestions: { tr: 'Tekil sorular', en: 'Individual questions', fr: 'Questions individuelles' },
  surveyAssignAllCategories: { tr: 'Tüm başlıklar', en: 'All topics', fr: 'Tous les thèmes' },
  surveyAssignSearch: { tr: 'Soru ara…', en: 'Search questions…', fr: 'Rechercher…' },
  surveyAssignSelectShown: { tr: 'Görünenleri seç', en: 'Select shown', fr: 'Sélectionner' },
  surveyAssignClear: { tr: 'Kaldır', en: 'Clear', fr: 'Retirer' },
  surveyAssignNoMatch: { tr: 'Bu filtreye uygun soru yok.', en: 'No questions match this filter.', fr: 'Aucune question ne correspond.' },
  surveyAssignViaCategory: { tr: 'başlıktan geliyor', en: 'via topic', fr: 'via le thème' },
  surveySettings: { tr: 'Anket Ayarları', en: 'Survey Settings', fr: 'Paramètres du sondage' },
  surveyDescription: { tr: 'Açıklama', en: 'Description', fr: 'Description' },
  surveyQuestions: { tr: 'Sorular', en: 'Questions', fr: 'Questions' },
  surveyAddQuestion: { tr: 'Soru Ekle', en: 'Add Question', fr: 'Ajouter une question' },
  surveyImportExcel: { tr: "Excel'den yükle", en: 'Import Excel', fr: 'Importer Excel' },
  surveyImportTemplate: { tr: 'Excel şablonu', en: 'Excel template', fr: 'Modèle Excel' },
  surveyImportSuccess: { tr: '{n} soru içe aktarıldı', en: '{n} question(s) imported', fr: '{n} question(s) importée(s)' },
  surveyImportEmpty: { tr: "Excel'de geçerli soru bulunamadı.", en: 'No valid questions found in the Excel file.', fr: 'Aucune question valide trouvée dans le fichier Excel.' },
  surveyImportFailed: { tr: 'Excel içe aktarma başarısız oldu.', en: 'Excel import failed.', fr: "Échec de l'import Excel." },
  surveyImportWarnings: { tr: '{n} uyarı — konsolu kontrol edin.', en: '{n} warning(s) — check the console.', fr: '{n} avertissement(s) — consultez la console.' },
  surveyNoQuestions: { tr: 'Henüz soru eklenmedi.', en: 'No questions added yet.', fr: 'Aucune question ajoutée.' },
  surveyQuestionText: { tr: 'Soru metni', en: 'Question text', fr: 'Texte de la question' },
  surveyQuestionCategory: { tr: 'Konu başlığı (kategori)', en: 'Topic (category)', fr: 'Thème (catégorie)' },
  surveyQuestionCategoryHint: { tr: 'Örn. Genel Memnuniyet — opsiyonel', en: 'e.g. General Satisfaction — optional', fr: 'ex. Satisfaction générale — optionnel' },
  surveyQuestionType: { tr: 'Tip', en: 'Type', fr: 'Type' },
  surveyOptionsHint: { tr: 'Seçenekler (her satıra bir seçenek)', en: 'Options (one per line)', fr: 'Options (une par ligne)' },
  surveyOptionsPlaceholder: { tr: 'Seçenek 1\nSeçenek 2\nSeçenek 3', en: 'Option 1\nOption 2\nOption 3', fr: 'Option 1\nOption 2\nOption 3' },
  surveyRequired: { tr: 'Zorunlu', en: 'Required', fr: 'Obligatoire' },
  sqTypeLikert: { tr: 'Puan ölçeği (Likert)', en: 'Rating scale (Likert)', fr: 'Échelle (Likert)' },
  sqTypeSingle: { tr: 'Tek seçim', en: 'Single choice', fr: 'Choix unique' },
  sqTypeMulti: { tr: 'Çoklu seçim', en: 'Multiple choice', fr: 'Choix multiple' },
  sqTypeText: { tr: 'Açık uçlu metin', en: 'Open text', fr: 'Texte libre' },
  sqTypeNps: { tr: 'NPS (0-10)', en: 'NPS (0-10)', fr: 'NPS (0-10)' },
  sqTypeYesno: { tr: 'Evet / Hayır', en: 'Yes / No', fr: 'Oui / Non' },
  sqTypeDate: { tr: 'Tarih', en: 'Date', fr: 'Date' },
  sqTypeRank: { tr: 'Sıralama', en: 'Ranking', fr: 'Classement' },
  // Sonuçlar
  surveyNoResponses: { tr: 'Henüz yanıt yok.', en: 'No responses yet.', fr: 'Aucune réponse pour le moment.' },
  surveyStatResponses: { tr: 'Yanıt', en: 'Responses', fr: 'Réponses' },
  surveyStatQuestions: { tr: 'Soru', en: 'Questions', fr: 'Questions' },
  surveyStatAvg: { tr: 'Ortalama', en: 'Average', fr: 'Moyenne' },
  surveyStatNps: { tr: 'NPS', en: 'NPS', fr: 'NPS' },
  surveyExportExcel: { tr: 'Excel indir', en: 'Export Excel', fr: 'Exporter Excel' },
  surveyAnswerWord: { tr: 'yanıt', en: 'answers', fr: 'réponses' },
  surveyAvgRank: { tr: 'Ort. sıra', en: 'Avg. rank', fr: 'Rang moy.' },
  // Public doldurma
  surveyClosedMsg: { tr: 'Bu anket şu anda yanıtlamaya kapalı.', en: 'This survey is currently closed.', fr: 'Ce sondage est actuellement fermé.' },
  surveyThanksTitle: { tr: 'Teşekkürler!', en: 'Thank you!', fr: 'Merci !' },
  surveyThanksMsg: { tr: 'Yanıtınız kaydedildi.', en: 'Your response has been recorded.', fr: 'Votre réponse a été enregistrée.' },
  surveyRequiredMissing: { tr: 'Lütfen zorunlu (*) soruları yanıtlayın.', en: 'Please answer the required (*) questions.', fr: 'Veuillez répondre aux questions obligatoires (*).' },
  surveySubmitFailed: { tr: 'Gönderim başarısız oldu.', en: 'Submission failed.', fr: 'Échec de l’envoi.' },
  surveyAnonymousNotice: { tr: 'Bu anket anonimdir; kimliğiniz kaydedilmez.', en: 'This survey is anonymous; your identity is not recorded.', fr: 'Ce sondage est anonyme ; votre identité n’est pas enregistrée.' },
  surveyYourAnswer: { tr: 'Yanıtınız...', en: 'Your answer...', fr: 'Votre réponse...' },
  surveySubmit: { tr: 'Gönder', en: 'Submit', fr: 'Envoyer' },
  surveyAiComingSoon: { tr: 'AI analiz bir sonraki aşamada etkinleşecek.', en: 'AI analysis will be enabled in the next phase.', fr: 'L’analyse IA sera activée à la prochaine étape.' },
  // AI panel
  surveyAiTitle: { tr: 'Yapay Zeka Analizi', en: 'AI Analysis', fr: 'Analyse IA' },
  surveyAiHint: { tr: 'Yanıtları SWOT, duygu analizi ve öneriler olarak analiz edin.', en: 'Analyze responses into SWOT, sentiment and recommendations.', fr: 'Analysez les réponses en SWOT, sentiment et recommandations.' },
  surveyAiCachedAt: { tr: 'Son analiz: {date} ({n} yanıt)', en: 'Last analysis: {date} ({n} responses)', fr: 'Dernière analyse : {date} ({n} réponses)' },
  surveyAiRun: { tr: 'AI ile Analiz Et', en: 'Analyze with AI', fr: 'Analyser avec l’IA' },
  surveyAiRerun: { tr: 'Yeniden Analiz Et', en: 'Re-analyze', fr: 'Réanalyser' },
  surveyAiRunning: { tr: 'Yapay zeka yanıtları analiz ediyor… (~30 sn)', en: 'AI is analyzing the responses… (~30s)', fr: 'L’IA analyse les réponses… (~30 s)' },
  surveyAiDone: { tr: 'Analiz tamamlandı', en: 'Analysis complete', fr: 'Analyse terminée' },
  surveyAiFailed: { tr: 'AI analizi başarısız oldu', en: 'AI analysis failed', fr: 'Échec de l’analyse IA' },
  surveyAiSummary: { tr: 'Yönetici Özeti', en: 'Executive Summary', fr: 'Résumé exécutif' },
  surveyAiSentiment: { tr: 'Duygu Analizi', en: 'Sentiment Analysis', fr: 'Analyse de sentiment' },
  surveyAiRecommendations: { tr: 'Öneriler ve Aksiyonlar', en: 'Recommendations & Actions', fr: 'Recommandations et actions' },
  surveyAiKeyFindings: { tr: 'Ana Bulgular', en: 'Key Findings', fr: 'Principaux constats' },
  swotStrengths: { tr: 'Güçlü Yönler', en: 'Strengths', fr: 'Forces' },
  swotWeaknesses: { tr: 'Zayıf Yönler', en: 'Weaknesses', fr: 'Faiblesses' },
  swotOpportunities: { tr: 'Fırsatlar', en: 'Opportunities', fr: 'Opportunités' },
  swotThreats: { tr: 'Tehditler', en: 'Threats', fr: 'Menaces' },
  priorityHigh: { tr: 'Yüksek', en: 'High', fr: 'Élevée' },
  priorityMedium: { tr: 'Orta', en: 'Medium', fr: 'Moyenne' },
  priorityLow: { tr: 'Düşük', en: 'Low', fr: 'Faible' },
  ...
  karneSelectPerson: { tr: 'Lütfen bir kişi seçin.', en: 'Please select a person.', fr: 'Veuillez sélectionner une personne.' },
  karsiKarneSelectPerson: { tr: 'Lütfen bir kişi seçin.', en: 'Please select a person.', fr: 'Veuillez sélectionner une personne.' },
  karneLoadError: { tr: 'Karne alınamadı', en: 'Could not load report card', fr: 'Impossible de charger la KARNE' },
  karsiKarneLoadError: { tr: 'Karne alınamadı', en: 'Could not load report card', fr: 'Impossible de charger la KARNE' },
  karneSearchLabel: {
    tr: 'İsim veya birim ara',
    en: 'Search by name or department',
    fr: 'Rechercher nom ou service',
  },
  karneSearchPlaceholder: {
    tr: 'Filtrelemek için yazın…',
    en: 'Type to filter…',
    fr: 'Filtrer…',
  },
  karneAllPeriods: {
  ...
  matrixKarneTitle: {
    ...
    en: 'Person report card — Matrix structure',
  ...
  adminReportsMaintenanceMessage: {
    tr: 'Kurum admin rapor ekranı geçici olarak güncelleniyor. Lütfen kısa süre sonra tekrar deneyin. Çalışanların kendi sonuçları «Dönemler → Sonuçları yayınla» ile yönetilir; değerlendirme formları etkilenmez.',
    en: 'The org admin reports screen is being updated. Please try again shortly. Employees’ own results are controlled via Periods → Release results; evaluation forms are not affected.',
    fr: 'L’écran rapports admin org. est en mise à jour. Réessayez bientôt. Les résultats des employés passent par Périodes → Publier ; les formulaires ne sont pas affectés.',
  },
  adminReportsMaintenanceToggle: {
    tr: 'Rapor bakım modu (kurum adminleri admin raporlarını göremez)',
    en: 'Reports maintenance mode (org admins cannot see admin reports)',
    fr: 'Mode maintenance rapports (admins org. ne voient pas les rapports admin)',
  },
  adminReportsMaintenanceToggleHint: {
    tr: 'Yalnızca süper admin admin raporlarını görür. Açıkken rapor geliştirmesi yapabilirsiniz. Çalışanların kendi sonuçları dönem menüsündeki «Sonuçları yayınla» ile açılır/kapanır.',
    en: 'Super admin only sees admin reports while on. Employee self-results use Periods → Release results, not this toggle.',
    fr: 'Super admin seul voit les rapports admin. Les résultats employés passent par Périodes → Publier les résultats.',
  },
  ...
  dashboardAssignedSurveys: { tr: 'Bana atanan anketler', en: 'Surveys assigned to me', fr: 'Enquêtes qui me sont attribuées' },
  dashboardAssignedSurveysQuestions: { tr: '{n} soru', en: '{n} questions', fr: '{n} questions' },
  dashboardAssignedSurveyFill: { tr: 'Doldur', en: 'Fill in', fr: 'Remplir' },
  dashboardAssignedSurveyCompleted: { tr: 'Tamamlandı', en: 'Completed', fr: 'Terminé' },
  dashboardAssignedSurveyReanswer: { tr: 'Tekrar doldur', en: 'Answer again', fr: 'Répondre à nouveau' },
